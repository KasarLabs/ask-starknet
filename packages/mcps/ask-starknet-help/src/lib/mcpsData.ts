...
export const MCPS_DATA = {
  ...
  erc20: {
    ...
    description:
      'Management of ERC20 operations (transfer, balance, deployment) on Starknet',
    promptInfo: {
  ...
  avnu: {
    ...
    description:
      'AVNU decentralized exchange integration for token swaps on Starknet',
    promptInfo: {
  ...
  fibrous: {
    ...
    description:
      'Fibrous decentralized exchange for single and batch token swaps',
    promptInfo: {
  ...
  openzeppelin: {
    ...
    description:
      'OpenZeppelin account contract creation and deployment on Starknet',
    promptInfo: {
  ...
  'starknet-rpc': {
    ...
    description:
      'Direct blockchain interaction via RPC methods for on-chain data access',
    promptInfo: {
  ...
  unruggable: {
    ...
    description:
      'Memecoin creation and analysis with focus on safer token launches',
    promptInfo: {
  ...
  vesu: {
    ...
    description:
      'Vesu protocol for deposit and withdrawal operations for earning positions',
    promptInfo: {
  ...
  ekubo: {
    ...
    description:
      'Ekubo decentralized exchange for liquidity management and token swaps',
    promptInfo: {
  ...
  extended: {
    ...
    description:
      'Extended high-performance perpetuals exchange on Starknet for trading derivatives with on-chain settlement',
    promptInfo: {
      expertise:
        'Perpetual derivatives trading, market data analysis, position and risk management, order execution, and account management on Extended exchange (Starknet L2)',
      tools: [
  ...
  endurfi: {
    ...
    description:
      'Endur.fi liquid staking protocol for STRK and BTC tokens (WBTC, tBTC, LBTC) on Starknet',
    promptInfo: {
      expertise:
        'Liquid staking with xSTRK, xyWBTC, xytBTC, and xyLBTC on Endur.fi',
      tools: [
        'preview_stake',
        'preview_unstake',
        'get_user_balance',
  ...
  'cairo-coder': {
    ...
    description:
      'AI-powered Cairo code assistance and Starknet general knowledge via Cairo Coder API',
    promptInfo: {
      expertise:
        'Cairo smart contract development, Starknet technical documentation, ecosystem knowledge, and recent Starknet news',
  ...
  'ask-starknet-help': {
    client: {
      command: 'npx',
      args: ['-y', '@kasarlabs/ask-starknet-help-mcp'],
      transport: 'stdio',
    },
    description:
      'Help and documentation for Ask Starknet: usage guide, architecture explanation, capabilities listing, project ideas, and troubleshooting',
    promptInfo: {
      expertise:
        'Ask Starknet help, usage guide, documentation, architecture explanation, available MCPs and tools, project ideas, and troubleshooting',
      tools: [
        'ask_starknet_help',
