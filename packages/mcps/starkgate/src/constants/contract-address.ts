...
export const STARKNET_BRIDGE_ADDRESS_MAP: Record<string, string> = {
  ...
  DAI: BRIDGE_STARKNET_TO_DAI_ETHEREUM_ADDRESS,
  LORDS: BRIDGE_STARKNET_TO_LORDS_ETHEREUM_ADDRESS,
};
...
export const ETHEREUM_BRIDGE_ADDRESS_MAP: Record<string, string> = {
  ...
  DAI: BRIDGE_ETHEREUM_TO_DAI_STARKNET_ADDRESS,
  LORDS: BRIDGE_ETHEREUM_TO_LORDS_STARKNET_ADDRESS,
